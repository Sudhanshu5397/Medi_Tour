                                                        ...
                                                        <td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <center><span style="color: gray">Achievements</span></center>
                                                                 ...
                                                                 <td>
                                                                <center><span style="color: gray">Verify</span></center>
                                                                </td>
                                            </tr>
                            ...
                            <div class="tab-content">
                              <div id="home" class="container tab-pane active"><br>
                                     ...
                                     <table border="1" class="table table-bordered">
                                            <tr>
                                                <td>
                                                    <center><span style="color: gray">User_Id</span></center>
                                                </td>
                                                <td>
                                                        <center> <span style="color: gray">First Name</span></center>
                                                    </td>
                                                    <td>
                                                            <center><span style="color: gray">Last Name</span></center>
                                                        </td>
                                                        <td>
                                                                <center><span style="color: gray">Age</span></center>
                                                            </td>
                                                            <td>
                                                                <center><span style="color: gray">Gender</span></center>
                                                                </td>
                                                                	<td>
                                                                <center><span style="color: gray">Contact Number</span></center>
                                                                </td>
                                                                	<td>
                                                                <center><span style="color: gray">Address</span></center>
                                                                </td>
                                                                	<td>
                                                                <center><span style="color: gray">City</span></center>
                                                                </td>
                                                                	<td>
                                                                <center><span style="color: gray">Zip Code</span></center>
                                                                </td>
                                            </tr>
